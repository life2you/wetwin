...
- When a release includes new release-flow or upgrade-flow capabilities, add those upgrade highlights to the GitHub Release page notes/changelog for that version.
